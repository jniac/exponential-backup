...
import { removeConsecutiveDuplicates } from './remove-duplicates'
...
const defaultOptions = {
  ...
  dryRun: false,
  verbose: false,
  strategy: 'exponentionalWithFlatDay' as StrategyArg,
}
...
async function backupWithPruning(source: string, incomingOptions: Options = {}) {
  ...
  const rangeMap = new TimeRangeMap<string>().strategy(strategy)
...
export {
  backupWithPruning,
  Options as BackupWithPruningOptions,
  defaultOptions as defaultBackupWithPruningOptions
}
